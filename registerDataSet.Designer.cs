...
namespace register {
    ...
    public partial class registerDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string username, string password, string confirm_password) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string confirm_password {
                get {
                    try {
                        return ((string)(this[this.tableTable.confirm_passwordColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'confirm password\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.confirm_passwordColumn] = value;
                }
            }
            ...
            public bool Isconfirm_passwordNull() {
                return this.IsNull(this.tableTable.confirm_passwordColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void Setconfirm_passwordNull() {
                this[this.tableTable.confirm_passwordColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace register.registerDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_confirm_password = 1 AND [confirm password] IS NULL) OR ([confirm password] = @Original_confirm_password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [username], [password], [confirm password]) VALU" +
                "ES (@Id, @username, @password, @confirm_password);\r\nSELECT Id, username, passwor" +
                "d, [confirm password] FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [username] = @username, [password] = @password, [confirm password] = @confirm_password WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_confirm_password = 1 AND [confirm password] IS NULL) OR ([confirm password] = @Original_confirm_password)));
SELECT Id, username, password, [confirm password] FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::register.Properties.Settings.Default.registerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, [confirm password] FROM dbo.[Table]";
        ...
        public virtual int Fill(registerDataSet.TableDataTable dataTable) {
        ...
        public virtual registerDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            registerDataSet.TableDataTable dataTable = new registerDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(registerDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, string Original_confirm_password) {
            ...
            if ((Original_confirm_password == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_confirm_password));
            }
        ...
        public virtual int Insert(int Id, string username, string password, string confirm_password) {
        ...
        public virtual int Update(int Id, string username, string password, string confirm_password, int Original_Id, string Original_username, string Original_password, string Original_confirm_password) {
            ...
            if ((Original_confirm_password == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_confirm_password));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string confirm_password, int Original_Id, string Original_username, string Original_password, string Original_confirm_password) {
            return this.Update(Original_Id, username, password, confirm_password, Original_Id, Original_username, Original_password, Original_confirm_password);
        }
    }
